...
<section class="success-panel">
  ...
  <h1>統合SQLを作成しました</h1><p>新規DBには全体SQLを使用します。基準SQLを取り込み済みの場合は、処理時間の短い統合差分SQLを続けて適用してください。</p>
  ...
  <div class="download-actions"><a class="button primary" href="?action=download&amp;type=sql"><span class="material-symbols-outlined" aria-hidden="true">download</span>統合済み全体SQL</a><a class="button secondary" href="?action=download&amp;type=delta"><span class="material-symbols-outlined" aria-hidden="true">download</span>統合差分SQL</a><a class="button secondary" href="?action=download&amp;type=report"><span class="material-symbols-outlined" aria-hidden="true">folder_zip</span>統合レポート</a></div>
</section>

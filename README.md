...
8. SQLite上の統合済みデータから主要テーブルを再生成した完全版SQLとJSONレポートを出力
...
テストは、プレフィックスの異なるWordPressダンプを使って、SQLite取込、同一記事判定、ID衝突、ACFシリアライズ値、ターム、Yoast、全体SQL、統合レポートを検証します。
